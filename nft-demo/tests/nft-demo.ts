...
// import { NftDemo } from "../target/types/nft_demo";


describe("nft-demo", async () => {
  ...
  const program = new anchor.Program(
    ...
    new anchor.web3.PublicKey("i25WSpXBBR8uk2YohMHVjkG67JuM8KEY7fZiTeLNrxQ"),
  );
  // ** Comment this to use solpg imported IDL **
  // const program = anchor.workspace.NftDemo as anchor.Program<NftDemo>;
